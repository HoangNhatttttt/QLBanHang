...
public class ThemQuyenForm extends javax.swing.JFrame {
    ...
    public ThemQuyenForm(Quyen parent) {
        ...
        // Tự động tạo mã quyền mới
        txtMaQuyen.setText(qlqBUS.getNextID());
        txtMaQuyen.setEditable(false); // Không cho người dùng sửa mã
    }
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (qlqBUS.getQuyen(maQuyen) != null) {
            JOptionPane.showMessageDialog(this, "Mã quyền đã tồn tại!", "Lỗi", JOptionPane.ERROR_MESSAGE);
            return;
        }
        
        // Tạo đối tượng quyền mới và thêm vào CSDL
        QuyenDTO quyen = new QuyenDTO(maQuyen, tenQuyen, chiTietQuyen);
        boolean ketQua = qlqBUS.add(quyen);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemQuyenForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
